    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className={`${isSidebarCollapsed ? 'w-20' : 'w-72'} transition-all duration-300 ease-in-out fixed left-0 top-0 h-full z-50`}>
        <CollapsibleSidebar
          ...
          panelColor="from-emerald-500 to-teal-600"
        />
      </div>
              ...
              <div className="hidden md:flex items-center">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-64 pl-10 pr-4 py-2 bg-gray-100 border-0 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all duration-200"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 xl:hidden">
                ...
                <div className="flex items-center gap-3">
                  {user?.profilePictureUrl ? (
                    ...
                    <div className="w-9 h-9 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center ring-2 ring-gray-100">
